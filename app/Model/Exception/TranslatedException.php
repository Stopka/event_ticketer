...
class TranslatedException extends Exception {
    ...
    public function __construct(string $message = "", ?int $count = null, array $params = [], int $code = 0, Throwable $previous = null) {
    ...
    public function getTranslatedMessage(ITranslator $translator) {
        ...
        if (!isset($parameters['reason']) && is_subclass_of($e, TranslatedException::class)) {
